...
import { FaHandHoldingMedical, FaHeartbeat, FaChild, FaHospital, FaRunning, FaVial, FaHandHoldingWater, FaBandAid } from "react-icons/fa";
  ...
  return (
    <section className="py-10 sm:py-16 lg:py-24 z-40 relative">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 justify-items-center">
